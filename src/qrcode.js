...
export default function () {
    ...
    qrcode.vidSuccess = function (stream) 
    {
        ...
        qrcode.canvas_qr2.id = qrcode.inCanvasID;
    ...
    qrcode.decode = function(src){
        ...
        if(arguments.length==0)
        {
            ...
            {
                var canvas_qr = document.getElementById(qrcode.inCanvasID);
        ...
        else
        {
            ...
            image.onload=function(){
                ...
                var canvas_out = document.getElementById(qrcode.outCanvasID);
                if(canvas_out!=null)
                {
